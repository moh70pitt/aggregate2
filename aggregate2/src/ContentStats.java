...
public class ContentStats {
	...
	public ContentStats(String name, String providerId, 
			double a_p10, double a_p25, double a_p33, double a_p50, double a_p66, double a_p75, double a_p80, double a_p85, double a_p90, 
			double t_p10, double t_p25, double t_p33, double t_p50, double t_p66, double t_p75, double t_p80, double t_p85, double t_p90,
			double sr_p10, double sr_p25, double sr_p33, double sr_p50, double sr_p66, double sr_p75, double sr_p80, double sr_p85, double sr_p90) {
		super();
		this.name = name;
	...
	public String asPartialJSON(){
		return  "\"aP\":["+this.a_p10+","+this.a_p25+","+this.a_p33+","+this.a_p50+","+this.a_p66+","+this.a_p75+","+this.a_p80+","+this.a_p85+","+this.a_p90+"],"+
				"\"tP\":["+this.t_p10+","+this.t_p25+","+this.t_p33+","+this.t_p50+","+this.t_p66+","+this.t_p75+","+this.t_p80+","+this.t_p85+","+this.t_p90+"],"+
				"\"srP\":["+this.sr_p10+","+this.sr_p25+","+this.sr_p33+","+this.sr_p50+","+this.sr_p66+","+this.sr_p75+","+this.sr_p80+","+this.sr_p85+","+this.sr_p90+"]";
	}
