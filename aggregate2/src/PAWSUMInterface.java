...
public class PAWSUMInterface implements UMInterface {
  // private String server = "http://pawscomp2.sis.pitt.edu";//Commented by
  // @Jordan for debugging in localhost
  ...
  public HashMap<String, double[]> getContentSummary(String usr, String grp, String sid, String cid, String domain,
    ...
    // HashMap<String,String> contentWithProvider =
    // generateContentList(contentByProvider);
    contentSummary = new HashMap<String, double[]>();

    // fill the hashmap kcByContent with content_name, arraylist of [concept_name,
    // weight, direction]
    ...
    // HashMap<String, String[]> user_activity = getUserContentActivity(usr,
    // domain);
    ...
    for (Map.Entry<String, String[]> content : contentList.entrySet()) {
      ...
      if (content_provider.equalsIgnoreCase("webex") || content_provider.equalsIgnoreCase("animatedexamples")) {
        ...
        // knowledge, progress, attempts/loads, success rate, completion, other 1, other
        // 2
  ...
  // HashMap<String,String> contentWithProvider specify which are the content we
  // are interested on
          ...
          if (contentList.containsKey(content_name)) {
            ...
            if (conceptListStr == null
              ...
              for (int j = 0; j < concepts.length; j++) {
                ...
                // if(concept.length<3) System.out.println(" "+j+" "+content_name+"
                // "+concept[0]+" "+concept.length);
                conceptList.add(concept); // concept_name, weight, direction
                // if(contentList.get(content_name)[5].equals("webex")){
                // System.out.println(" "+concepts[j]+" " + concept[0] + " " + concept[1] + " "
                // + concept[2]);
                //
                // }
              }
  ...
  public HashMap<String, Activity> getContentSummaryV2(
